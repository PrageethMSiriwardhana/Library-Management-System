...
if __name__ == "__main__":
    ...
    Royallibrary = Library(
        ["islandnation", "colonialpast", "war&peace", "sinhala", "lankanecon", "villagelife"])
    student = Student()
    track = []
    ...
    while (True):
        ...
        try:
            ...
            if usr_response == 1:  # listing
                Royallibrary.displayAvailableBooks()
            elif usr_response == 2:  # borrow
                Royallibrary.borrowBook(
                    input("Enter your name: "), student.requestBook())
            elif usr_response == 3:  # return
                Royallibrary.returnBook(student.returnBook())
            elif usr_response == 4:  # donate
                Royallibrary.donateBook(student.donateBook())
